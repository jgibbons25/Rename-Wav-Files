...
The code will then rename the files, assuming the title of the subfolder is the shot name, and that each take is a collection of all layer files.

In my case, a file named "16_001_1.WAV" in folder "2B" will get renamed to "2B-T1_boom.wav"
